    ...
    public class TextureStreamSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (toolResults != null)
            {
                ...
                DrawAnalysisSection("Enabled Streaming", toolResults.enabledList, toolResults.enabledFullText, ref enabledFoldout, ref enabledTextFoldout);
                DrawAnalysisSection("Already Streaming", toolResults.alreadyList, toolResults.alreadyFullText, ref alreadyFoldout, ref alreadyTextFoldout);
                DrawAnalysisSection("Skipped", toolResults.skippedList, toolResults.skippedFullText, ref skippedFoldout, ref skippedTextFoldout);
                DrawAnalysisSection("Disabled Streaming", toolResults.disabledList, toolResults.disabledFullText, ref disabledFoldout, ref disabledTextFoldout);
                DrawAnalysisSection("Updated", toolResults.updatedList, toolResults.updatedFullText, ref updatedFoldout, ref updatedTextFoldout);
            }
        }
