...
namespace SLZ.Marrow.Zones
{
    ...
    public class SceneChunk : MonoBehaviour
    {
        ...
        [SerializeField]
        internal MarrowScene[] sceneLayers = Array.Empty<MarrowScene>();
        ...
        [SerializeField]
        internal ZoneCuller[] zoneCullers = Array.Empty<ZoneCuller>();
        [Space(10)]
        [Tooltip("Trigger events once this SceneChunk is loaded.")]
        [SerializeField]
        private UltEvent onChunkLoad = new();
        [Space(10)]
        [Tooltip("Trigger events once this SceneChunk is loaded.")]
        [SerializeField]
        private UltEvent onChunkUnload = new();
        [HideInInspector]
